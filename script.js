...
const featureData = {
  media: {
    ...
    htmlContent: `
      <div class="fisto-vw-wrapper media-wrapper">
        ...
        <img class="custom-feature-img image-image-1" src="assets/images/content-images/images-videos-and-gifs/catalogue-left-image-1.webp" alt="left image 1">
        <img class="custom-feature-img image-image-2" src="assets/images/content-images/images-videos-and-gifs/catalogue-left-image-2.webp" alt="left image 2">
        <img class="custom-feature-img gif-image-1" src="assets/images/content-images/images-videos-and-gifs/gif-image.gif" alt="Gif Image">
        <video class="custom-feature-img video-1" src="assets/images/content-images/multi-view-product-experience/360-product-rotate.mp4" alt="Video image" controls autoplay loop muted></video>
        <img id="audioBtn" class="audio-button" src="assets/images/content-images/images-videos-and-gifs/audio-icon-off.svg" alt="Audio Toggle" />
  ...
  background: {
    ...
    description: "Personalize your catalogue with custom Colors, Themes, Images, and Video backgrounds. Create a branded experience that reflects your identity and enhances visual appeal.",
    htmlContent: `
  ...
  gallery: {
    ...
    htmlContent: `
      <div class="fisto-vw-wrapper gallery-library-wrapper">
        <div class="gl-book-container">
          <img class="gl-book-bg" src="assets/images/content-images/gallery-and-library-experience/flipbook-svg.svg" alt="Book Background">
          
          <div class="gl-page-left">
            <div class="gl-row-top">
              <img class="gl-title-left" src="assets/images/content-images/gallery-and-library-experience/organize-your-content-beautifully-text.svg" alt="Organize Your Content Beautifully">
              <img class="gl-img-1" src="assets/images/content-images/gallery-and-library-experience/organize-image-row-1.webp" alt="Dashboard">
            </div>
            <div class="gl-gallery-grid">
              <div class="gl-row-mid">
                <img class="gl-img-2-1" src="assets/images/content-images/gallery-and-library-experience/organize-image-row-2-1.webp" alt="Model">
                <img class="gl-img-2-2" src="assets/images/content-images/gallery-and-library-experience/organize-image-row-2-2.webp" alt="AR">
                <img class="gl-img-2-3" src="assets/images/content-images/gallery-and-library-experience/organize-image-row-2-3.webp" alt="Book">
              </div>
              <div class="gl-row-large">
                <img class="gl-img-3-1" src="assets/images/content-images/gallery-and-library-experience/organize-image-row-3-1.webp" alt="Alternator">
                <img class="gl-img-3-2" src="assets/images/content-images/gallery-and-library-experience/organize-image-row-3-2.webp" alt="Animation">
              </div>
              <div class="gl-row-bottom">
                <img class="gl-img-4-1" src="assets/images/content-images/gallery-and-library-experience/organize-image-row-4-1.webp" alt="Packaging">
                <img class="gl-bottom-text" src="assets/images/content-images/gallery-and-library-experience/organize-bottom-text.svg" alt="Text">
              </div>
            </div>
          </div>
          
          <div class="gl-page-right">
            <img class="gl-title-right" src="assets/images/content-images/gallery-and-library-experience/manage-and-access-catalogues-easily-text.svg" alt="Manage &amp; Access Catalogues Easily">
            <div class="gl-shelves-container">
              <img class="gl-shelf" src="assets/images/content-images/gallery-and-library-experience/book-shelf-1.webp" alt="Shelf 1">
              <img class="gl-shelf" src="assets/images/content-images/gallery-and-library-experience/book-shelf-2.webp" alt="Shelf 2">
              <img class="gl-shelf" src="assets/images/content-images/gallery-and-library-experience/book-shelf-3.webp" alt="Shelf 3">
            </div>
            <img class="gl-desc-right" src="assets/images/content-images/gallery-and-library-experience/organize-right-page-text.svg" alt="Organize and showcase...">
          </div>
        </div>

        <div class="gl-buttons-row">
          <div class="gl-indicator gl-ind-left">
            <img class="gl-btn-arrow" src="assets/images/content-images/gallery-and-library-experience/gallery-page.svg" alt="Gallery Page Arrow">
            <img class="gl-btn-pill" src="assets/images/content-images/gallery-and-library-experience/gallery-page.svg" alt="Gallery Page">
          </div>
          <div class="gl-indicator gl-ind-right">
            <img class="gl-btn-arrow" src="assets/images/content-images/gallery-and-library-experience/library-page.svg" alt="Library Page Arrow">
            <img class="gl-btn-pill" src="assets/images/content-images/gallery-and-library-experience/library-page.svg" alt="Library Page">
          </div>
        </div>
      </div>
    `
  ...
  "linking-prod": {
    ...
    description: "Highlight important product features, benefits, and specifications to help customers quickly understand what makes each product unique.",
    htmlContent: `
  ...
  flip: {
    ...
    description: "Experience realistic page-flipping effects with multiple viewing styles, including Soft Flip, Hard Cover, Auto Flip, and Drag-to-Flip interactions. Designed to make digital catalogues feel more natural, engaging, and interactive.",
    htmlContent: `
  ...
  mobile: {
    ...
    description: "Enjoy a seamless viewing experience across smartphones, tablets, laptops, and desktops. The catalogue automatically adapts to different screen sizes, ensuring smooth navigation, fast loading, and an engaging user experience on any device.",
    htmlContent: `
      <div class="fisto-vw-wrapper cross-device-wrapper">
        <div class="cd-left-col" id="cd-left-svg-container">
        </div>
        <div class="cd-right-col">
          <div class="cd-devices-container">
            <img src="assets/images/content-images/cross-device-compatibiliy/laptop-screen.webp" class="cd-laptop" alt="Laptop">
            <img src="assets/images/content-images/cross-device-compatibiliy/tab-screen-with-holder.webp" class="cd-tablet" alt="Tablet">
            <img src="assets/images/content-images/cross-device-compatibiliy/mobile-screen-with-rock.webp" class="cd-mobile" alt="Mobile">
          </div>
        </div>
      </div>
    `
  ...
  fingertips: {
    ...
    htmlContent: `
      <div class="fisto-vw-wrapper multi-func-wrapper">
        <div class="mf-container">
          <img class="custom-feature-img mf-bg" src="assets/images/content-images/multi-functional-layouts/desktop-catalogue-image.webp" alt="Desktop Catalogue">
          <div id="mf-svg-container" class="mf-svg-overlay"></div>
        </div>
      </div>
    `
  },
  'multi-view': {
    ...
    description: "Experience products from every angle with interactive 3D and exploded views. Switch between the complete product and individual components to better understand its design and structure.",
    htmlContent: `
  ...
  'product-selection': {
    ...
    description: "Enable users to browse and filter products by categories or groups, making it easy to find and explore the right products directly within the catalogue.",
    htmlContent: `
  ...
  embed: {
    ...
    description: "Enhance your catalogue by embedding maps, videos, and other external content directly within catalogue pages.",
    htmlContent: `
      <div class="fisto-vw-wrapper">
        ...
        <iframe id="embed-video-player" class="embed-content-anim-1" src="https://www.youtube.com/embed/MAsWVxsteUo?si=lc6uLpn8Ps8xXNNV" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        ...
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3916.5280862473164!2d76.98663437570495!3d10.998948855048468!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba85953c17a7027%3A0xea6e3a8566c8dbf9!2sFISTO%20TECH%20PRIVATE%20LIMITED!5e0!3m2!1sen!2sin!4v1781588853072!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" id="embed-map-box" class="embed-map-static"></iframe>
  ...
  '360-view': {
    ...
    htmlContent: `
      <div class="fisto-vw-wrapper fisto-360-wrapper animate-360" id="fisto-360-main-wrapper">
        <img class="custom-feature-img catalogue-image-360-feature" src="assets/images/content-images/360-image/catalogue-image.webp" alt="360 View Catalogue">
        
        <img class="fisto-360-mouse" src="assets/images/content-images/360-image/mouse-image.webp" alt="Mouse Icon">

        <div class="fisto-360-replay-btn" onclick="const w = document.getElementById('fisto-360-main-wrapper'); w.classList.remove('animate-360'); void w.offsetWidth; w.classList.add('animate-360'); document.getElementById('fisto-360-color-picker').value='#ffffff'; document.getElementById('fisto-360-body').style.background=''; " style="position: absolute;
          bottom: 1vw;
          right: 1vw;
          z-index: 100;
          background: white;
        ...
        " title="Replay Animation">
          <svg width="1.5vw" height="1.5vw" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"></path><path d="M3 3v5h5"></path></svg>
        </div>

        <div class="fisto-360-popup">
          <div class="fisto-360-popup-header">
            <div class="fisto-360-header-left">
              <img src="assets/images/content-images/multi-view-product-experience/360-image.svg" alt="360" class="fisto-360-icon">
              <span>3D Product Visualization</span>
            </div>
            <img class="fisto-360-logo" src="assets/images/fisto-logo.png" alt="FIST-O TECH" onerror="this.style.display='none'">
          </div>
          
          <div class="fisto-360-popup-body" id="fisto-360-body">
            <model-viewer 
              src="assets/images/content-images/360-image/bottle-3d-image.glb" 
              auto-rotate 
              ...
              id="model-viewer-360"
              scale="1 1 1"
              data-zoom="100" disable-tap disable-zoom disable-pan
            ></model-viewer>
            
            <div class="fisto-360-popup-footer">
              <div class="fisto-360-toggles">
                <div class="fisto-360-toggle-item">
                  <span>Auto Rotate Model</span>
                  <div class="fisto-toggle-switch active" onclick="this.classList.toggle('active'); const mv = document.getElementById('model-viewer-360'); if(this.classList.contains('active')) { mv.setAttribute('auto-rotate', ''); } else { mv.removeAttribute('auto-rotate'); }">
                    <div class="fisto-toggle-knob"></div>
                  </div>
                </div>
                <div class="fisto-360-toggle-item">
                  <span>BackGround Color</span>
                  <div class="fisto-color-box-wrapper" style="position: relative; width: 1.2vw; height: 1.2vw; border: 1px solid #ccc; border-radius: 0.2vw; overflow: hidden; cursor: pointer;">
                    <input type="color" id="fisto-360-color-picker" value="#ffffff" style="position: absolute; top: -1vw; left: -1vw; width: 3vw; height: 3vw; cursor: pointer; border: none; padding: 0;" oninput="document.getElementById('fisto-360-body').style.background = this.value;">
                  </div>
                </div>
              </div>
              <div class="fisto-360-footer-right">
                <svg onclick="const mv = document.getElementById('model-viewer-360'); let z = parseInt(mv.dataset.zoom || 100); if(z > 80) { z -= 20; mv.dataset.zoom = z; const s = z/100; mv.setAttribute('scale', s + ' ' + s + ' ' + s); document.getElementById('fisto-360-zoom-text').innerText = z + '%'; }" style="cursor: pointer;" width="1vw" height="1vw" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line><line x1="8" y1="11" x2="14" y2="11"></line></svg>
                <span id="fisto-360-zoom-text" style="font-size: 0.65vw; font-weight: 600;">100%</span>
                <svg onclick="const mv = document.getElementById('model-viewer-360'); let z = parseInt(mv.dataset.zoom || 100); if(z < 120) { z += 20; mv.dataset.zoom = z; const s = z/100; mv.setAttribute('scale', s + ' ' + s + ' ' + s); document.getElementById('fisto-360-zoom-text').innerText = z + '%'; }" style="cursor: pointer;" width="1vw" height="1vw" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line><line x1="11" y1="8" x2="11" y2="14"></line><line x1="8" y1="11" x2="14" y2="11"></line></svg>
              </div>
            </div>
          </div>
        </div>
...
function setActiveFeature(featureKey) {
  ...
  if (window.smartNavInterval) {
    clearInterval(window.smartNavInterval);
    window.smartNavInterval = null;
  }
  if (window.smartNavTocInterval) {
    clearInterval(window.smartNavTocInterval);
    window.smartNavTocInterval = null;
  }
  ...
  if (customHtmlContainer) {
    if (feature.htmlContent) {
      ...
      if (featureKey === 'multi-view') {
       ...
       if (featureKey === 'media') {
        setTimeout(() => {
          ...
          if (audioBtn) {
            // Use the background music audio if available, otherwise create a silent placeholder
            const bgMusic = document.getElementById('bg-music');
            let audioEl = bgMusic || null;
            ...
            audioBtn.addEventListener('click', () => {
              isPlaying = !isPlaying;
              if (isPlaying) {
                audioBtn.src = 'assets/images/content-images/images-videos-and-gifs/audio-icon.svg';
                if (audioEl) audioEl.play().catch(() => {});
              } else {
                audioBtn.src = 'assets/images/content-images/images-videos-and-gifs/audio-icon-off.svg';
      ...
      if (featureKey === 'fingertips') {
        setTimeout(() => {
          fetch('assets/images/content-images/multi-functional-layouts/complete-arrows-and-buttons.svg')
            .then(r => r.text())
            .then(svg => {
              svg = svg.replace('<svg ', '<svg style="width: 100%; height: 100%;" ');
              
              // Groups 0-9 are buttons/labels
              for (let i = 0; i <= 9; i++) {
                const delay = (0.7 + (i * 0.1)).toFixed(1);
                svg = svg.replace(new RegExp('<g filter="(url\\(#filter' + i + '_[^"]+\\))">'), 
                                  '<g class="mf-anim-btn" style="animation-delay: ' + delay + 's;" filter="$1">');
              }
              
              // Groups 10-23 are arrows. Give them a base class.
              for (let i = 10; i <= 23; i++) {
                svg = svg.replace(new RegExp('<g filter="(url\\(#filter' + i + '_[^"]+\\))">'), 
                                  '<g class="mf-anim-arrow mf-arrow-idx-' + i + '" filter="$1">');
              }

              const container = document.getElementById('mf-svg-container');
              if (container) {
                container.innerHTML = svg;
                
                // Dynamically assign wipe directions based on arrow position
                const svgEl = container.querySelector('svg');
                if (svgEl) {
                   const cx = 919 / 2;
                   const cy = 665 / 2;
                   const arrows = svgEl.querySelectorAll('.mf-anim-arrow');
                   
                   arrows.forEach((arrow, index) => {
                       const bbox = arrow.getBBox();
                       const arrowCx = bbox.x + bbox.width / 2;
                       const arrowCy = bbox.y + bbox.height / 2;
                       
                       let animName = "";
                       // Determine primary direction based on difference from center
                       const dx = cx - arrowCx;
                       const dy = cy - arrowCy;
                       ...
                       // Staggered delay for drawing
                       const delay = (1.5 + (index * 0.05)).toFixed(2);
                       arrow.style.animation = `${animName} 0.6s ease-out forwards ${delay}s`;
                   });
                }
              }
            });
      ...
      if (featureKey === 'mobile') {
        setTimeout(() => {
          fetch('assets/images/content-images/cross-device-compatibiliy/left-side-icon-features.svg')
            .then(r => r.text())
            .then(svg => {
              const container = document.getElementById('cd-left-svg-container');
              if (container) {
                container.innerHTML = svg;
                const svgEl = container.querySelector('svg');
                if (svgEl) {
                  svgEl.setAttribute('class', 'cd-features-svg-inline');
                }
              }
            });
        }, 50);
      ...
      if (featureKey === 'smart-nav') {
        setTimeout(() => {
          const tocList = document.querySelector('.sn-toc-list');
          const thumbScroll = document.querySelector('.sn-thumbnails-scroll');
          ...
          if(tocList) {
              tocList.addEventListener('mouseenter', () => isPaused = true);
              tocList.addEventListener('mouseleave', () => isPaused = false);
          }
          if(thumbScroll) {
              thumbScroll.addEventListener('mouseenter', () => isPaused = true);
              thumbScroll.addEventListener('mouseleave', () => isPaused = false);
          }

          window.smartNavTocInterval = setInterval(() => {
             if(isPaused) return;
             if(tocList) {
                tocList.scrollTop += tocDir;
                if(tocList.scrollTop + tocList.clientHeight >= tocList.scrollHeight - 1) tocDir = -1;
                else if(tocList.scrollTop <= 0) tocDir = 1;
             }
          }, 50); // Slightly reduced speed (50ms vs 30ms)

          window.smartNavInterval = setInterval(() => {
             if(isPaused) return;
             if(thumbScroll) {
                thumbScroll.scrollLeft += thumbDir;
                if(thumbScroll.scrollLeft + thumbScroll.clientWidth >= thumbScroll.scrollWidth - 1) thumbDir = -1;
                else if(thumbScroll.scrollLeft <= 0) thumbDir = 1;
             }
          }, 30);
        }, 50);
      }
      ...
      if (featureKey === 'background') {
        setTimeout(() => {
          ...
          if (themeLayer && !themeLayer.hasAttribute('data-particles-added')) {
            themeLayer.setAttribute('data-particles-added', 'true');
            for(let i=0; i<30; i++) {
              ...
              themeLayer.appendChild(p);
            }
            
            // Mouse move water bubbles
            if (catalogueWrapper) {
              catalogueWrapper.addEventListener('mousemove', (e) => {
                ...
                // Randomize size for stardust (make rounds bigger)
                const size = Math.random() * 1.0 + 0.8; // 0.8vw to 1.8vw
...
async function runPreloader() {
  ...
  const w = document.getElementById('fisto-360-main-wrapper'); 
  if (w) w.classList.remove('animate-360');
  ...
  if (w) {
    ...
    w.classList.add('animate-360'); 
    
    const colorPicker = document.getElementById('fisto-360-color-picker');
    if (colorPicker) colorPicker.value = '#ffffff';
    
    const bodyEl = document.getElementById('fisto-360-body');
